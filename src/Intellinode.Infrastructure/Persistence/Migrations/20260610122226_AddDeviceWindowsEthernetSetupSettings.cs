...
{
    /// <summary>
    /// Sprint 1: device_windows_ethernet_settings, settings_kind.WindowsEthernetSetup.
    /// Down does not remove the PostgreSQL enum value (not supported without recreating the type).
    /// </summary>
    public partial class AddDeviceWindowsEthernetSetupSettings : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.Sql(
                """
                ALTER TYPE intellinode.settings_kind ADD VALUE IF NOT EXISTS 'WindowsEthernetSetup';
                """);

            migrationBuilder.CreateTable(
                name: "device_windows_ethernet_settings",
                schema: "intellinode",
                columns: table => new
                {
                    ...
                    obtain_dns_automatically = table.Column<bool>(type: "boolean", nullable: false),
                    network_speed = table.Column<string>(type: "character varying(64)", maxLength: 64, nullable: false, defaultValue: "AutoSelect"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_device_windows_ethernet_settings", x => x.device_id);
                    table.CheckConstraint("ck_device_windows_ethernet_settings_settings_version", "settings_version >= 0");
                    table.ForeignKey(
                        name: "fk_device_windows_ethernet_settings_devices_device_id",
