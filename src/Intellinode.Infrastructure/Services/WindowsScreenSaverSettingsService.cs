...
public sealed partial class WindowsScreenSaverSettingsService : IWindowsScreenSaverSettingsService
{
    ...
    {
        if (string.Equals(functionName, WindowsScreenSaverModuleConstants.InstantFunctionName, StringComparison.OrdinalIgnoreCase))
        {
            return "instant";
        }

        if (string.Equals(functionName, WindowsScreenSaverModuleConstants.QueuedFunctionName, StringComparison.OrdinalIgnoreCase))
        {
            return "queued";
        }
